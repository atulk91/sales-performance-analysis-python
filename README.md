...
![City-wise Sales Revenue](Images/City_wise_revenue.png)

### Product-wise Sales Revenue

![Product-wise Sales Revenue](Images/Product_wise_revenue.png)
...
Built an interactive Power BI dashboard with KPI cards, city-wise and product-wise revenue analysis, monthly sales trends, Month-on-Month growth, category revenue share, and slicers for Year, City, Product, and Category.
## How to Run
